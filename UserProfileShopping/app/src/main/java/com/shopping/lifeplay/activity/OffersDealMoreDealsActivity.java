...
public class OffersDealMoreDealsActivity extends AppCompatActivity implements OffersDealAdapter.Product_OnItemClicked {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offers_deal_more_deals);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getdatafromIntent();
        /*****************(Start) code For Card View*****************/

        recyclerView = (RecyclerView) findViewById(R.id.offerdatamoreRecuclerView);
    ...
    public void Product_onItemClick(int position) {
        ...
        Log.d("name", offerDeal.getOffer_deal_id() + "");
    ...
    private void signupRequest() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.GET, "http://littlejoy.co.in/admin_parilok/users/merchant.php",
                        ...
                        try {
                            ...
                            if (jsonObject.getString("status").equals("STATUS_SUCCESS")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    merchant_image = "http://littlejoy.co.in/admin_parilok/api/" + merchant_image;
                                ...
                                MyProgressDialog.hidePDialog();
                                Toast.makeText(OffersDealMoreDealsActivity.this, "No data Found", Toast.LENGTH_LONG).show();
                ...
                new com.android.volley.Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(OffersDealMoreDealsActivity.this, "Network Error", Toast.LENGTH_LONG).show();
                        MyProgressDialog.hidePDialog();
                    }
                }
        );
