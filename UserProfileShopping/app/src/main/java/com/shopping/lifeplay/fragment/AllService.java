 ...
 * {@link AllService.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AllService#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AllService extends Fragment implements ProductAdapter.Product_OnItemClicked, ProductAdapter.Product_OnClicked {
     ...
     * @return A new instance of fragment AllService.
     */
    // TODO: Rename and change types and number of parameters
    public static AllService newInstance(String param1, String param2) {
        AllService fragment = new AllService();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.allproduct_recyclerView);
...
//        intent.putExtra("p_uses", product.getProduct_uses() + "");
        Toast.makeText(getContext(), product.getProduct_id() + "getProduct_id", Toast.LENGTH_LONG).show();
